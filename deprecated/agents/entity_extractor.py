...
class EntityExtractor:
    ...
    def extract(self, fact_text: str, chunk_text: str, header_path: str = "") -> List[FinancialRelation]:
        ...
        prompt = (
            ...
            f"    - '[Company] has subsidiaries including [Sub1], [Sub2], and [Sub3]' → 3 relations\n"
        ...
        # All retries failed
        print(f"Entity extraction failed for fact: {last_error}")
    ...
    def _add_schema_reminder(self, prompt: str, error_context: str) -> str:
        ...
        return prompt + (
            f"\n\n⚠️ PREVIOUS ATTEMPT FAILED: {error_context}\n"
